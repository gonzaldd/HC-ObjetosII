    ...
    <div class="row">
        <div class="panel panel-primary filterable">
		 ...
		 <form method="post" action="/HC/MostrarHistoriaClinica" class="navbar-form navbar-left" role="search">
			<button id="inicio" name="dniPaciente" type="submit" class="btn btn-primary" value="<%= paciente.getDniPaciente() %>"><a href="/HC/MostrarHistoriaClinica"><span style="color: #FFFFFF; cursor:pointer;">Ver historia clínica del paciente</span></a></button>
		</form>
		</div>
