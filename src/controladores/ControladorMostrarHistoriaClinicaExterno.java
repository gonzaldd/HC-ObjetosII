...
public class ControladorMostrarHistoriaClinicaExterno extends HttpServlet {
	...
	try {
		...
		request.getRequestDispatcher("/vistaHistoriaClinicaExterno.jsp").forward(request ,response);
